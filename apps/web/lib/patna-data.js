...
export const homeHeroCards = [
  {
    type: "Policy Brief",
    title: "LEAP Phase II: Shaping Africa's voice at the IMO",
    summary:
      "Deepening technical and diplomatic capacity to influence global climate and energy rules.",
    meta: "Latest insight · Maritime",
  },
  {
    type: "Event",
    title: "African Strategic Summit, Abuja",
    summary: "Continental alignment on shipping decarbonisation and African negotiating priorities.",
    meta: "Completed · 200+ delegates",
  },
  {
    type: "Community",
    title: "Cohorts, working groups, and member coordination spaces",
...
export const homePillars = [
  {
    ...
    proof: "Research grounded in African data.",
  },
  {
    number: "02",
    title: "Coordination",
    subtitle: "Aligned positions, one voice",
    body: "Africa's 54 member states share common interests in equitable transition outcomes but historically arrive at international forums without aligned positions. PATNA convenes delegations, negotiators, and experts to build shared understanding and coordinated negotiating positions before sessions.",
    proof: "Aligned positions, one voice.",
  },
  {
    number: "03",
    title: "Advisory",
    ...
    proof: "Complexity translated into action.",
  },
];
...
export const leapPhases = [
  {
    ...
    body: "Phase I built the evidentiary foundation that no one had built before. Working with the UCL Energy Institute and in-country academic partners, PATNA produced five national shipping emissions inventories — the first ever compiled for African states from their own national port call and AIS data. Malawi, as a landlocked state, was included through a distinct methodology tailored to its specific trade exposure. The phase also produced country-level economic impact case studies quantifying the consequences of four IMO policy scenarios on each country's key import and export commodities: cocoa, crude oil, tobacco, iron ore, fertilisers, tea, uranium, and timber. African delegations arrived at MEPC 81–82 with evidence they owned. Not positions derived from other people's data — their own.",
    sourceUrl: "/projects/leap-phase-i",
  },
  {
    slug: "leap-phase-ii",
    ...
    body: "Phase II turned a project into a permanent institution. PATNA was formally registered as an NGO secretariat. The programme expanded to 25 African countries, adding nine Francophone states — Benin, Cameroon, Cabo Verde, Côte d'Ivoire, Congo, Guinea, Mauritania, Senegal, and Togo. All LEAP materials were translated into French and Portuguese. The centrepiece of Phase II was the Dakar Maritime Decarbonisation Workshop (August 2025), co-organised with the Government of Senegal, MOWCA, MOESNA, and the IMO Secretariat. Over 100 delegates from 25 African IMO Member States attended. The Workshop produced the 15 Dakar Declarations — a set of agreed negotiating principles adopted as a unified African position ahead of the IMO's MEPC/ES.2 Extraordinary Session in October 2025.",
    sourceUrl: "/projects/leap-phase-ii",
  },
  {
    slug: "leap-phase-iii",
...
export const homePublications = {
  featured: {
    date: "May 2026",
    type: "Meeting Report",
    title: "Report on the MEPC 84, IMO London",
    subtitle: "Africa-grounded evidence for the next stage of IMO decision-making.",
    body: "PATNA's latest meeting intelligence tracks the issues, coalition dynamics, and equity questions shaping Africa's position as IMO negotiations move toward the formal adoption and implementation of the Net-Zero Framework.",
...
export const researchLeadership = [
  {
    name: "Dr Dolapo Oluteye",
    title: "PATNA Founder and UCL Energy Institute researcher",
    body: "Principal Investigator of the LEAP series. Leads technical strategy and analytical framework design.",
  },
  {
    name: "Assoc. Prof. Tristan Smith",
    title: "UCL Energy Institute",
    body: "Co-Investigator of the LEAP series. Leads UCL's shipping decarbonisation modelling programme.",
  },
  {
    name: "Marie Fricaudet",
    title: "UCL Energy Institute",
    body: "Researcher responsible for emissions inventories, lifecycle assessment, and country-level impact modelling.",
  },
  {
    name: "Fitzroy Meyer-Petgrave",
    title: "Senior Research Associate",
    body: "MSc Data Science – Senior Research Associate with the LEAP project series and the PATNA Initiative. Works with principal investigator Dr Dola.",
  },
];
...
export const applicationCohortOptions = [
  ...
  { slug: "civil-society", label: "Civil Society" },
];

export const applicationDomainOptions = [
  { slug: "maritime-decarbonisation", label: "Maritime Decarbonisation" },
  { slug: "energy-transition", label: "Energy Transition" },
  { slug: "climate-finance", label: "Climate Finance" },
  { slug: "imo", label: "IMO" },
  { slug: "unfccc", label: "UNFCCC" },
  { slug: "sids", label: "SIDS" },
  { slug: "ldcs", label: "LDCs" },
  { slug: "west-africa", label: "West Africa" },
];

export const applicationExpertiseOptions = [
  { slug: "technical-scientific-research", label: "Technical / Scientific Research" },
  { slug: "policy-governance", label: "Policy / Governance" },
  { slug: "maritime-blue-economy", label: "Maritime & Blue Economy" },
  { slug: "climate-environment", label: "Climate & Environment" },
  { slug: "academia-education", label: "Academia & Education" },
  { slug: "civil-society-ngo", label: "Civil Society / NGO" },
  { slug: "private-sector-industry", label: "Private Sector / Industry" },
  { slug: "student-early-career", label: "Student / Early Career" },
  { slug: "other", label: "Other" },
];

export const applicationEngagementOptions = [
  { slug: "membership", label: "Membership (individual or institutional)" },
  { slug: "volunteering", label: "Volunteering" },
  { slug: "partnerships-collaborations", label: "Partnerships / Collaborations" },
  { slug: "research-publications", label: "Contributing to research or publications" },
  { slug: "events-workshops", label: "Attending events and workshops" },
  { slug: "capacity-building-training", label: "Capacity building and training opportunities" },
  { slug: "other", label: "Other" },
];
...
export const memberSpaces = [
  {
    ...
    unread: 3,
    role: "Lead",
    summary: "Policy coordination, negotiation prep, and shared drafting across the cohort.",
  },
  {
    slug: "sids-coalition",
    name: "SIDS Coalition",
    ...
    unread: 1,
    role: "Member",
    summary: "Cross-regional coordination for SIDS positions and shared intervention strategy.",
  },
  {
    slug: "imo-strategy-working-group",
    name: "IMO Strategy WG",
    type: "Working Group",
    kind: "working_group",
    members: 11,
    threads: 8,
    unread: 0,
    role: "Member",
    summary: "Focused drafting and review work tied to IMO strategy and technical submissions.",
  },
  {
    slug: "ldc-energy-taskforce",
    name: "LDC Energy Taskforce",
    type: "Working Group",
    kind: "working_group",
    members: 9,
    threads: 3,
    unread: 2,
    role: "Member",
    summary: "Targeted coordination around LDC energy transition issues and evidence gathering.",
  },
];
...
export const memberApplications = [
  ...
  },
  {
    ...
    organisation: "UCT Energy Institute",
    cohort: "Academic",
    status: "submitted",
    actionLabel: "Review",
  },
...
export const memberHighlights = [
  {
    title: "Feedback on IMO MEPC 83 Draft Outcomes",
    space: "Policy Cohort",
    author: "C. Okonkwo",
    time: "2h ago",
    replies: 6,
  ...
  {
    title: "Pacific alignment on GHG levy",
    space: "SIDS Coalition",
    author: "T. Ravuiwasa",
    time: "5h ago",
    replies: 3,
  },
  {
    title: "African co-sponsorship template for upcoming session",
    space: "IMO Strategy WG",
    author: "You",
    time: "1d ago",
    replies: 11,
  },
  {
    title: "COP30 preparation brief",
    space: "Policy Cohort",
    author: "A. Mwangi",
    time: "2d ago",
    replies: 4,
...
export const memberDirectory = [
  {
    ...
    role: "Policy Adviser",
    country: "Senegal",
    organisation: "DEEC Senegal",
    expertise: ["IMO Negotiations", "SIDS", "COP"],
  },
  {
    name: "Chidi Okonkwo",
    ...
    country: "Nigeria",
    organisation: "NIMASA",
    expertise: ["Shipping Decarbonisation", "GHG Levy"],
  },
  {
    name: "Aisha Mwangi",
    ...
    country: "Kenya",
    organisation: "KMA",
    expertise: ["NDCs", "Energy Transition"],
  },
];
